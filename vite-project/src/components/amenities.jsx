...
// function Amenities() {
//   return (
//     // <div className="container bg-zinc-500 w-full min-h-screen flex flex-col md:flex-row p-6">
//     <div className="bg-zinc-500 w-full min-h-screen flex flex-col md:flex-row p-6">

//       {/* Left Section - Amenities Count */}
//       <div className="amenities-count border-2 pt-8 bg-white w-full md:w-[40%] flex flex-col justify-center items-center py-10">
//         <div className="border-8 flex flex-col justify-center items-center w-full h-full p-6 text-center">
//           <h1 className="font-bold text-6xl md:text-8xl text-[#004236]">10+</h1>
//           <h3 className="font-bold text-3xl md:text-5xl">Premium</h3>
//           <h3 className="font-bold text-3xl md:text-5xl">Amenities</h3>
//         </div>
//       </div>

//       {/* Right Section - Amenities Cards */}
//       <div className="card-container bg-[#004236] w-full md:w-[60%] flex justify-center items-center p-6">
...
//               />
//               <h4 className="bg-orange-300 text-center text-white text-lg md:text-xl py-2 font-semibold">
//                 {item}
//               </h4>
//             </div>
//           ))}
